...
uname -s| grep Linux && pivnet download-product-files --product-slug='tanzu-cluster-essentials' --release-version='1.5.0' --product-file-id=1460876 && mv tanzu-cluster-essentials-darwin-amd64-1.5.0.tgz gorkem/

mkdir gorkem/tanzu-cluster-essentials
tar -xvf gorkem/tanzu-cluster-essentials-darwin-amd64-1.5.0.tgz -C gorkem/tanzu-cluster-essentials
